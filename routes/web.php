...
use App\Http\Controllers\Customer\ClientFactureController;
...
Route::prefix('AFT_LOUIS_BLERIOT')->middleware(['auth', 'role:agent'])->group(function () {
    ...
    Route::prefix('aftlb_colis')->name('aftlb_colis.')->group(function(){
        ...
        Route::post('paiement-colis', [AftlbColisController::class, 'enregistrer_paiement'])->name('valide.payer');
                ...
                //TOUT COLIS
        Route::get('/get-tout-colis',[AftlbColisController::class, 'get_tout_colis'])->name('get.tout.colis');
        Route::get('/colis-tout',[AftlbColisController::class, 'tout_colis'])->name('tout.colis');
    ...
    Route::prefix('aftlb_transport')->name('aftlb_transport.')->group(function(){
        ...
        // Nouvelles routes pour les programmes
        ...
        Route::delete('/programme/{programmeId}/item/{itemId}', [ProgrammeLBController::class, 'deleteProgrammeItem'])->name('programme.deleteItem');
        Route::put('/programme-update-items/{id}', [ProgrammeLBController::class, 'updateProgrammeItems'])->name('programme.updateItems');
        // Routes chauffeurs
...
Route::prefix('AGENCE_CHINE')->middleware(['auth', 'role:agent'])->group(function () {
    ...
    Route::prefix('chine_colis')->name('chine_colis.')->group(function(){
        ...
        Route::get('/get-colis-hold-aft-louis-b', [ChineColisController::class, 'get_colis_hold'])->name('get.colis.hold');
        Route::get('/devis-confirmes-aft-louis-b', [ChineColisController::class, 'devisConfirme'])->name('devis.confirme');
        ...
        Route::get('/get-tout-colis',[ChineColisController::class, 'get_tout_colis'])->name('get.tout.colis');
        Route::get('/colis-tout',[ChineColisController::class, 'tout_colis'])->name('tout.colis');
