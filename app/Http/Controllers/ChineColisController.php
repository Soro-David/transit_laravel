...
private function generateReferenceParMode(string $mode_transit)
{
    ...
    $agence = 'Agence de Chine'; // ou récupérer dynamiquement si nécessaire
...
public function vol_fermer(Request $request)
{
    try {
        ...
        $updatedCount = Colis::where('etat', 'Chargé')
            ...
            ->update([
                'etat' => 'Fermé',
                'reference_vol' => $referenceVol // même champ que conteneur, mais nommé différemment
            ]);
...
public function enregistrer_paiement(Request $request)
{
    ...
    public function edit_hold($id)
    {
        ...
        return view('AGENCE_CHINE.colis.edit_hold',['colis_recap_list' => $colis_recap_list]);
    }
...
public function destroy_colis_valide($reference)
{
    ...
    public function edit_colis_valide($id)
    {
        ...
        return view('AGENCE_CHINE.colis.edit_colis_valide', [
    ...
    public function updateMultipleColis(Request $request)
    {
        ...
        if ($finalRedirectColisId) {
            return redirect()->route('chine_colis.valide.edit.invoice', ['id' => $finalRedirectColisId])
                ->with('success', 'Les modifications ont été enregistrées avec succès !');
        }

        return redirect()->route('chine_colis.colis.valide')
            ->with('success', 'Les modifications ont été enregistrées avec succès !');
    }
...
public function get_colis_hold(Request $request)
{
    ...
    {
        return view('AGENCE_CHINE.colis.tout_colis');
    }
...
public function liste_colis_par_bateau($reference_conteneur)
{
    ...
    public function historique_contenaire()
    {
        ...
        return view('AGENCE_CHINE.cargaison.historique_contenaire');
    }
    ...
    public function get_contenaires(Request $request)
    {
        ...
        return datatables()->of($contenaires)
            ->addColumn('action', function ($row) {
                $listColisUrl = route('chine_colis.liste.colis.par.contenaire', [
    ...
    {
        return view('AGENCE_CHINE.cargaison.liste_colis_contenaire', compact('reference_contenaire'));
    }
    ...
    {
        // Cette vue contient la table '#contenairesTable'
        return view('AGENCE_CHINE.cargaison.historique_vol');
    }
    ...
    public function get_vol(Request $request)
    {
        ...
        return datatables()->of($vol)
            ->addColumn('action', function ($row) {
                $listColisUrl = route('chine_colis.liste.colis.par.vol', [
    ...
    {
        return view('AGENCE_CHINE.cargaison.liste_colis_vol', compact('reference_vol'));
    }
    ...
    public function cargaison_ferme(Request $request)
    {
        ...
        $mois = Carbon::now()->translatedFormat('m');
        $annee = Carbon::now()->year;

        // 7. Retourner la vue avec les données compactées
        return view('AGENCE_CHINE.cargaison.cargaison_ferme', compact(
            'agencesDestination',
