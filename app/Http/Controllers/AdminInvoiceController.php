...
class AdminInvoiceController extends Controller
{
    ...
    public function store_invoice()
    {
        ...
        $colisCollection = Colis::where('reference_colis', $reference_colis)->get();
    ...
    {
        return view('admin.invoice.historique');
    }
    ...
    public function get_invoice_historique(Request $request)
    {
        if ($request->ajax()) {
