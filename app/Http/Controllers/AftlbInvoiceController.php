...
class AftlbInvoiceController extends Controller
{
    /**
    ...
    {
        return view('AFT_LOUIS_BLERIOT.invoice.nouvelle');
    }
    ...
    {
        return view('AFT_LOUIS_BLERIOT.invoice.historique');
    }


    public function edit_invoice()
    {
        return view('AFT_LOUIS_BLERIOT.invoice.edit_invoice');
    }

    public function show_invoice()
    {
        return view('AFT_LOUIS_BLERIOT.invoice.show_invoice');
    }
