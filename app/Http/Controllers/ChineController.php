...
class ChineController extends Controller
{
    //
...
public function index()
{
    ...
    public function destroy($nom, $prenom, $tel, $email)
    {
        ...
        return redirect()->route('chine_client.index')->with('success', 'Client supprimé avec succès.');
    }
    ...
    public function show($type_client, $id)
    {
        ...
        return view('AGENCE_CHINE.client.show', compact('client', 'type_client'));
    }
    ...
    public function clients(Request $request)
    {
        ...
        $activeUsers = Expediteur::where('agence', 'Agence de Chine')
            ->distinct()
    ...
    public function edit($id)
    {
        ...
        return view('AGENCE_CHINE.client.edit', compact('client'));
    }
    ...
    public function update(Request $request, $email)
    {
        ...
        return redirect()->route('chine_client.index')->with('success', 'Client mis à jour avec succès.');
    }
    ...
    public function deactivateAccount($id)
    {
        ...
        return redirect()->route('chine_client.index')->with('success', 'Compte désactivé.');
    }
    ...
    public function toggleActivation($id)
    {
        ...
        return redirect()->route('chine_client.index')
        ...
        $phoneNumbers = User::where('is_active', true)
            ->where(function($query) {
                $query->whereHas('expediteur', function($q) {
                    $q->where('agence', 'Agence de Chine');
                })
