...
class AftlbMessagingController extends Controller
{
    /**
     * Le nom de l'agence AFT Louis Bleriot.
     * Utilisé pour filtrer toutes les requêtes.
     */
    const AGENCE_NOM = 'AFT Agence Louis Bleriot';
    ...
    public function index()
    {
        ...
        return view('AFT_LOUIS_BLERIOT.client.index', compact('containerReferences', 'flightReferences'));
    }
