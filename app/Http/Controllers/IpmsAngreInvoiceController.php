...
class IpmsAngreInvoiceController extends Controller
{
    /**
    ...
    {
        return view('IPMS_SIMEXCI_ANGRE.invoice.nouvelle');
    }
    ...
    public function store_invoice()
    {
        ...
        $colisCollection = Colis::where('reference_colis', $reference_colis)
            ->join('destinataires', 'colis.destinataire_id', '=', 'destinataires.id')  // Jointure avec la table expediteurs
            ->whereIn('colis.etat', ['Dechargé'])  // Filtre sur l'état des colis
            ->where('destinataires.agence', 'IPMS-SIMEX-CI Angre 8ème Tranche')  // Filtre sur l'agence de l'expéditeur
            ->get(); 
    ...
    {
        return view('IPMS_SIMEXCI_ANGRE.invoice.historique');
    }


    public function edit_invoice()
    {
        return view('IPMS_SIMEXCI_ANGRE.invoice.edit_invoice');
    }

    public function show_invoice()
    {
        return view('IPMS_SIMEXCI_ANGRE.invoice.show_invoice');
    }
