...
class IpmsInvoiceController extends Controller
{
    /**
    ...
    {
        return view('IPMS_SIMEXCI.invoice.nouvelle');
    }
    ...
    public function store_invoice()
    {
        ...
        $colisCollection = Colis::where('reference_colis', $reference_colis)
            ...
            ->where('destinataires.agence', 'IPMS-SIMEX-CI')  // Filtre sur l'agence de l'expéditeur
            ->get();  
    ...
    {
        return view('IPMS_SIMEXCI.invoice.historique');
    }


    public function edit_invoice()
    {
        return view('IPMS_SIMEXCI.invoice.edit_invoice');
    }

    public function show_invoice()
    {
        return view('IPMS_SIMEXCI.invoice.show_invoice');
    }
