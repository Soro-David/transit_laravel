...
class ProgrammeIPMXANGREController extends Controller
{
    public function index()
    {
        return view('IPMS_SIMEXCI_ANGRE.transport.planing');
    }

    public function data()
    { // Modifier la requête pour filtrer les chauffeurs par agence_id = 1 ou 6
        $chauffeurs = Chauffeur::whereIn('agence_id', [1, 6])->get();
