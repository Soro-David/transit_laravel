    ...
    <div class="container">
        ...
        {{-- <div class="stats-container">
            ...
            <div class="stat-card stat-paye">
                <div class="stat-number">{{ number_format($totalPaye, 0, ',', ' ') }} FCFA</div>
                <div class="stat-label">MONTANT PAYÉ</div>
            </div>
            <div class="stat-card stat-reste">
                <div class="stat-number">{{ number_format($totalReste, 0, ',', ' ') }} FCFA</div>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr class="totaux-row">
                        ...
                        <td class="montant text-right text-bold">{{ number_format($totalMontant, 0, ',', ' ') }} FCFA</td>
                        <td class="montant text-right text-bold">{{ number_format($totalPaye, 0, ',', ' ') }} FCFA</td>
                        <td class="montant text-right text-bold">{{ number_format($totalReste, 0, ',', ' ') }} FCFA</td>
                        <td colspan="7"></td>
                    </tr>
                    @endif
                </tbody>
