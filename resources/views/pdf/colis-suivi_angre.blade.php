            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th style="width: 14%;">Expéditeur / Tél.</th>
                        <th style="width: 14%;">Destinataire / Tél.</th>
                ...
                <tbody>
                    ...
                    @empty
                    <tr>
                        <td colspan="10" class="text-center" style="padding: 20px;">Aucun colis validé trouvé.</td>
                    </tr>
                    @endforelse
