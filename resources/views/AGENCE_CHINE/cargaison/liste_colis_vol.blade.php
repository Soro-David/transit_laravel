        ...
        <div class="col-12">
            <div class="border p-4 rounded shadow-sm">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <a href="{{ route('chine_colis.historique.vol') }}" class="btn btn-secondary">
...
$(document).ready(function () {
    ...
    var table = $("#colisTable").DataTable({
        ...
        // **** CORRECTION : URL AJAX dynamique qui inclut la référence du Vol ****
        ajax: '{{ route("chine_colis.get.colis.pour.vol", ["reference_vol" => $reference_vol]) }}',
        columns: [
