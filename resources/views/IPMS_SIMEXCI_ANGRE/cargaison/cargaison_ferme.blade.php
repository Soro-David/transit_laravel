        ...
        <div class="col-md-12">
            <div class="card border-0 rounded shadow-sm">
                ...
                <div class="card-body p-4">
                    <form action="{{ route('ipms_angre_colis.bateaux.store') }}" method="POST">
                        @csrf
                        <div class="row g-3 align-items-center">
                            ...
                            <!-- Champs du ballon -->
                            <div class="col-md-3 ballon-fields">
                            ...
                            <input type="hidden" name="agence_expedition" value="{{ old('agence_expedition', 'IPMS-SIMEX-CI Angre 8ème Tranche') }}">
...
$(document).ready(function () {
    var table = $("#productTable").DataTable({
        ...
        ajax: '{{ route("ipms_angre_colis.get.cargaison.ferme") }}', // Récupération des données via AJAX
            columns: [
