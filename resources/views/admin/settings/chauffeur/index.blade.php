...
<ul class="horizontal-nav">
    ...
    <li class="active"><a href="{{route('setting.chauffeur.index')}}">Chauffeurs</a></li>
</ul>
<div class="card mx-auto mt-5" style="max-width: 800px;"> <!-- Augmenter la largeur de la carte -->
    <div class="card-header text-center">
        <h5>Paramètre Chauffeurs</h5>
    </div>
    <div class="card-body" style="padding: 30px;">
        <form>
            <div class="mb-3 text-center">
                <label for="mode_transit" class="form-label">Sélectionnez Un Chauffeur</label>
