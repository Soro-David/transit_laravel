            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <input type="text" name="first_name" id="first_name" 
                            value="{{$users->first_name}}" class="form-control" readonly>
                </div>
            </div>
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <input type="text" name="last_name" id="last_name" 
                            value="{{$users->last_name}}" class="form-control" readonly>
                </div>
            </div>
            <div class="col-md-6">
                <div class="mb-3">
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <input type="text" name="role" id="role" 
                            value="{{$users->role}}" class="form-control" readonly>
                </div>
            </div>
        </div>
    </div>
   {{-- Bouton valider --}}
   <div class="text-left mt-4 d-flex justify-content-start gap-2">
