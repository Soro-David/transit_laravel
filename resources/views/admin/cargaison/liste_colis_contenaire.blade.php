        ...
        <div class="col-12">
            <div class="border p-4 rounded shadow-sm">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <a href="{{ route('cargaison.historique.contenaire') }}" class="btn btn-secondary">
...
$(document).ready(function () {
    ...
    var table = $("#colisTable").DataTable({
        ...
        ajax: '{{ route("cargaison.get.colis.pour.contenaire", ["reference_contenaire" => $reference_contenaire]) }}',
        columns: [
