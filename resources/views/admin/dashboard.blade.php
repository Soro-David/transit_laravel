    ...
    <div class="container-fluid">
        ...
        <div class="dashboard-bar p-3 mb-4 bg-white rounded">
            ...
            <div class="scrolling-container">
                <h4 class="scrolling-agency">AFT Import Export</h4>
            </div>
        </div>
...
<script>
    ...
    function fetchColisCounts() {
        fetch('{{ route('admin_colis.vol-cargaison-count') }}')
        ...
        fetch('{{ route('admin_colis.conteneur-count') }}')
            .then(response => response.json())
            .then(data => {
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    async function fetchDataAndUpdateChart() {
        try {
            const response = await fetch('{{ route('admin_colis.valides-par-mois') }}');
