        ...
        <div class="row d-flex justify-content-around mb-4">
            ...
            {{-- Carte Destinataire --}}
             <div class="col-md-5 col-lg-4">
                  <div class="card border-0 rounded shadow-sm">
                     <div class="card-header bg-light border-0">
                         <h4 class="card-title text-center mb-0 fw-bold">Destination</h4>
                     </div>
                    <div class="card-body p-4">
                         @if(isset($first))
                         <div class="mb-3 d-flex align-items-center">
                             <label class="form-label fw-bold w-50">Nom :</label>
                             <span class="form-control-plaintext w-50">{{ $first['nom_destinataire'] ?? '' }} {{ $first['prenom_destinataire'] }} {{ $first['nom_destinataire_societe'] ?? '' }}</span>
                         </div>
                         <div class="mb-3 d-flex align-items-center">
                             <label class="form-label fw-bold w-50">Téléphone:</label>
