                    ...
                    <div class="row">
                        <div class="container">
                            <div class="d-flex justify-content-between">
                                <div class="text-left">
                                    <button type="button" class="btn gradient-orange-blue" data-bs-toggle="modal" data-bs-target="#info_expediteur">
                                        Ajouter l'Expéditeur
                                    </button>
                                </div>
                                <div class="text-right">
                                    <button type="button" class="btn gradient-orange-blue" data-bs-toggle="modal" data-bs-target="#info_destinataire">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="email" name="expediteur_email" id="expediteur_email" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label for="expediteur_telephone" class="form-label">Téléphone</label>
                                                        <input type="text" name="expediteur_telephone" id="expediteur_telephone" class="form-control" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label for="type_facture" class="form-label">Type Facture</label>
                                        ...
                                        <div class="container">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label class="form-label">Prénom</label>
                                                        <input type="text" name="destinataire_prenom" id="destinataire_prenom" class="form-control" required>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="email" name="destinataire_email" id="destinataire_email" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label for="destinataire_telephone" class="form-label">Téléphone</label>
                                                        <input type="text" name="destinataire_telephone" id="destinataire_telephone" class="form-control" required>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label for="lieu_livraison" class="form-label">Livraison</label>
