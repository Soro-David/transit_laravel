{{-- views/admin/transport/depot.blade.php --}}
...
@section('content')
<div class="container-fluid">
    <form id="depotForm" action="{{ route('transport.programme.createMultipleDepot') }}" method="POST">
        @csrf
        <div class="row">
            <div class="col-lg-12">
        ...
        <div class="row">
            <div class="col-12 text-right mb-4">
                <a href="{{ route('transport.planing.chauffeur') }}" class="btn btn-secondary">Annuler</a>
...
$(document).ready(function() {
    ...
    $('#date_programme_depot_modal').attr('min', currentDate);
        ...
        axios.post($('#depotForm').attr('action'), new FormData($('#depotForm')[0]))
            .then(res => {
                Swal.fire({
                    ...
                    window.location.href = "{{ route('transport.planing.chauffeur') }}";
                });
            })
            .catch(err => {
