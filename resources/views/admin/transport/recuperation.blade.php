{{-- views/admin/transport/recuperation.blade.php --}}
...
@section('content')
<div class="container-fluid">
    <form id="recuperationForm" action="{{ route('transport.programme.createMultipleRecuperation') }}" method="POST">
        @csrf
        <div class="row">
            <div class="col-lg-12">
        ...
        <div class="row">
            <div class="col-12 text-right mb-4">
                <a href="{{ route('transport.planing') }}" class="btn btn-secondary">Annuler</a>
...
$(document).ready(function() {
    ...
    function loadChauffeurs() {
        axios.get("{{ route('transport.programme.data') }}")
    ...
    let url = `{{ route('transport.programme.referenceInfo', ['reference' => 'PLACEHOLDER']) }}`.replace('PLACEHOLDER', reference);
