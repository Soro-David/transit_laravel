{{-- views/admin/transport/planing.blade.php --}}
...
$(document).ready(function() {
    ...
    function initApp() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                const url = "{{ route('transport.programme.destroy', ['programme' => 'PROGRAMME_ID']) }}".replace('PROGRAMME_ID', programmeId);
    ...
    function loadData() {
        showLoading(true);
        return axios.get("{{ route('transport.programme.data') }}")
        ...
        programmes.forEach(p => {
            ...
            const actionsHtml = etat !== 'effectué' ? 
               `<div class="btn-group btn-group-sm">
                    <a href="{{ route('transport.programme.edit.page', '') }}/${p.id}-aft-louis-b" class="btn btn-outline-info" title="Modifier">
