    ...
    function chargerInformationsCompletesDuDevis(programmeId) {
        $.ajax({
            ...
            success: function(response) {
                ...
                // La ligne `colisFieldset.show();` a été supprimée.
                // La visibilité du fieldset est maintenant gérée UNIQUEMENT par la logique
                // de navigation des étapes (la fonction `showStep`), ce qui est le comportement attendu.
                // ================================================================================= //
...
$(document).ready(function () {
    ...
    function attachColisEventListeners(colisElement) {
        initAutocomplete(colisElement.find(".produit-input"), "{{ route('aftlb_colis.recherche.auto') }}", 'Colis');
