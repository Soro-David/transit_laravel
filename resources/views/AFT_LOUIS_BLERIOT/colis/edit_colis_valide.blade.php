                    ...
                    <div class="form-section">
                        ...
                        <div class="sub-section">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <label>Nom</label>
                                    <input type="text" name="nom_expediteur" value="{{ $info_partagees->expediteur->nom ?? '' }}" class="form-control" required>
                                </div>
                                <div class="col-md-3">
                                    <label>Prénom</label>
                                    <input type="text" name="prenom_expediteur" value="{{ $info_partagees->expediteur->prenom ?? '' }}" class="form-control" required>
                                </div>
                                <div class="col-md-3">
                                    <label>Contact</label>
                                    <input type="text" name="tel_expediteur" value="{{ $info_partagees->expediteur->tel ?? '' }}" class="form-control" required>
                                </div>
                                <div class="col-md-3">
                                    <label class="form-label">Agence d'expédition</label>
                                    <select name="agence_expediteur" class="form-control" required>
                                        <option value="AFT Agence Louis Bleriot"> 	AFT Agence Louis Bleriot</option>
                                    </select>
                                </div>
                                <div class="col-md-3">
                                    <label>Référence</label>
                                    <input type="text" value="{{ $reference ?? '' }}" class="form-control" disabled>
                                </div>
                            </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#client_select').on('keyup', function() {
            ...
            $.ajax({
                url: "{{ route('aftlb_colis.clients.search') }}", // URL pour la recherche de clients
                dataType: 'json',
                data: { q: query },
                success: function(data) {
