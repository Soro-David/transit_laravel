...
<section class="p-4 mx-auto">
    <div class="form-container text-center">
        ...
        <div>
            <a href="{{ route('aftlb_colis.edit.facture', ['id' => $premierColis->id ?? 0]) }}" target="_blank" class="btn btn-sm btn-info">
                ...
                @foreach($colisEnregistres as $index => $colis)
                    <div class="list-group-item list-group-item-action flex-column align-items-start mb-3 shadow-sm rounded border-0">
                        ...
                        <div class="mt-2 text-end"> {{-- Boutons alignés à droite --}}
                            <a href="{{ route('aftlb_colis.edit.etiquette', ['id' => $colis->id]) }}" target="_blank" class="btn btn-sm btn-success me-2">
