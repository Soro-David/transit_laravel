...
<section class="p-4 mx-auto">
    <div class="form-container text-center">
        ...
        <div class="d-flex align-items-center gap-2">
            <a href="{{ route('ipms_colis.imprimer.facture', ['id' => $first['id']]) }}" target="_blank" class="btn btn-sm btn-info d-flex align-items-center">
                <i class="fas fa-file-invoice me-1"></i> Imprimer Facture
            </a>
        
            <a href="{{ route('ipms_colis.imprimer.bon_livraison', ['id' => $first['id']]) }}" target="_blank" class="btn btn-sm btn-secondary d-flex align-items-center">
        ...
        <div class="list-group">
            <div class="list-group-item list-group-item-action flex-column align-items-start mb-3 shadow-sm rounded border-0">
                ...
                <div class="mt-2 text-end">
                    <a href="{{ route('ipms_colis.imprimer.etiquette', ['id' => $colis[0]->id]) }}" target="_blank" class="btn btn-sm btn-success me-2">
