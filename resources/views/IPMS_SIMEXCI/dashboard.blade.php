    ...
    <div class="container-fluid">
        ...
        <div class="dashboard-bar p-3 mb-4 bg-white rounded">
            ...
            <div class="scrolling-container">
                <h4 class="scrolling-agency">IPMS-SIMEX-CI</h4>
            </div>
        </div>
...
<script>
    ...
    function fetchColisCounts() {
        fetch('{{ route('ipms_colis.vol-cargaison-count') }}')
        ...
        fetch('{{ route('ipms_colis.conteneur-count') }}')
            .then(response => response.json())
            .then(data => {
    ...
    function fetchTotalPrixTransit() {
        fetch('{{ route('ipms_colis.prix-total') }}')
            .then(response => response.json())
            .then(data => {
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    async function fetchDataAndUpdateChart() {
        try {
            const response = await fetch('{{ route('ipms_colis.valides-par-mois') }}');
