...
<section class="p-4 mx-auto">
    <form action="{{route('agent_colis.store.step3')}}" method="post" class="form-container">
        @csrf
        <div class="progress-card">
            <h3>Progression de la soumission</h3>
            <div class="progress-container">
                <div class="progress-bar" style="width: 60%;">Étape 3 / 5</div>
            </div>
        </div>
        ...
        <div class="form-section">
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        <label for="type_emballage" class="form-label">Type d'emballage</label>
...
<style>
    ...
    .progress-bar {
        height: 100%;
        width: 20%; /* Étape actuelle (20% pour la troisième étape) */
